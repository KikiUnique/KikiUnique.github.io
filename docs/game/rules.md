...
Combat
 ...
 - Your armour gives you an armour rating.
 	...
 	- Number of blows armour has taken refreshed between events or after receiving maintenance or repair with the appropriate skill (must be removed to be repaired).
 	- If you receive a blow greater than your armour rating or after the number of blows it can withstand the armour is broken and becomes useless till repaired.
...
Downtime and advancement
 ...
 - Each skill requires points spent to increase. The required amount is the number of the next level of that skill. These points are acquired during downtime, each slot will give you a point towards a skill. Occasionally you could gain other benefits instead.